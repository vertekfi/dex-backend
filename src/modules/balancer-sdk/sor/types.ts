...
export interface SorTokenPriceService {
  /**
...
export interface PoolBase {
  ...
  _exactTokenInForTokenOut: (poolPairData: PoolPairBase, amount: OldBigNumber) => OldBigNumber;
  _tokenInForExactTokenOut: (poolPairData: PoolPairBase, amount: OldBigNumber) => OldBigNumber;

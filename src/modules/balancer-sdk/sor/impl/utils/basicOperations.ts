...
class LogExpMath {
  ...
  static pow(x: bigint, y: bigint): bigint {
    ...
    _require(
      x < BigInt('57896044618658097711785492504343953926634992332820282019728792003956564819968'),
    ...
    if (this.LN_36_LOWER_BOUND < x_int256 && x_int256 < this.LN_36_UPPER_BOUND) {
      ...
      logx_times_y =
        (ln_36_x / this.ONE_18) * y_int256 + ((ln_36_x % this.ONE_18) * y_int256) / this.ONE_18;
    } else {

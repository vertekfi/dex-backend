...
export function setWrappedInfo(
  ...
  if (
    (isScaledWrapper(wrappedInfo.tokenIn.wrapType) && swapType === SwapTypes.SwapExactIn) ||
    (isScaledWrapper(wrappedInfo.tokenOut.wrapType) && swapType === SwapTypes.SwapExactOut)
  ) {
  ...
  if (swapType === SwapTypes.SwapExactIn && isScaledWrapper(wrappedInfo.tokenOut.wrapType)) {
    swapInfo.returnAmount = swapInfo.returnAmount.mul(ONE).div(wrappedInfo.tokenOut.rate);
  ...
  if (swapType === SwapTypes.SwapExactOut && isScaledWrapper(wrappedInfo.tokenIn.wrapType)) {
    swapInfo.returnAmount = swapInfo.returnAmount.mul(ONE).div(wrappedInfo.tokenIn.rate);

...
export class SwapCostCalculator {
  ...
  constructor(config: SorConfig, private readonly tokenPriceService: TokenPriceService) {
   ...
   */
  public setNativeAssetPriceInToken(tokenAddress: string, tokenPrice: string): void {
   ...
   * @param tokenAddress - the address of the token for which to express the native asset in terms of
   */
  private async getNativeAssetPriceInToken(tokenAddress: string): Promise<string> {

...
// suggested paths
const priceErrorTolerance: string = process.env.PRICE_ERROR_TOLERANCE || '0.00001';
export const PRICE_ERROR_TOLERANCE: OldBigNumber = new OldBigNumber(priceErrorTolerance);
